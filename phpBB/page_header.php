...
/***************************************************************************
    ...
    $Id: page_header.php,v 1.73 2001/03/28 08:02:20 thefinn Exp $ 
...
<TR>
	<TD ALIGN="CENTER"> <FONT FACE="<?php echo $FontFace?>" SIZE="<?php echo $FontSize1?>" COLOR="<?php echo $textcolor?>"> 
      </font> <font face="<?php echo $FontFace?>" size="<?php echo $FontSize1?>" color="<?php echo $textcolor?>">
      <?php		
		if ($user_logged_in)
		{
			// do PM notification.
...
<table border="1" BGCOLOR="<?php echo $color1?>" bordercolor="<?php echo $table_bgcolor?>">
        <tr> 
          <td BGCOLOR="<?php echo $color2?>"> 
            <div align="center"><font face="<?php echo $FontFace?>" size="<?php echo $FontSize1?>" color="<?php echo $textcolor?>"><a href="<?php echo $url_phpbb?>/bb_register.<?php echo $phpEx ?>?mode=agreement"> 
              <?php echo $l_register?>
              </a></font></div>
          </td>
          <td BGCOLOR="<?php echo $color2?>"> 
            <div align="center"><font face="<?php echo $FontFace?>" size="<?php echo $FontSize1?>" color="<?php echo $textcolor?>"><a href="<?php echo $url_phpbb?>/bb_profile.<?php echo $phpEx ?>?mode=edit"> 
              <?php echo $l_editprofile?>
              </a></font></div>
          </td>
          <td BGCOLOR="<?php echo $color2?>"> 
            <div align="center"><font face="<?php echo $FontFace?>" size="<?php echo $FontSize1?>" color="<?php echo $textcolor?>"><a href="<?php echo $url_phpbb?>/prefs.<?php echo $phpEx ?>"> 
              <?php echo $l_editprefs?>
              </a></font></div>
          </td>
          <td BGCOLOR="<?php echo $color2?>"> 
            <div align="center"><font face="<?php echo $FontFace?>" size="<?php echo $FontSize1?>" color="<?php echo $textcolor?>"><a href="<?php echo $url_phpbb?>/search.<?php echo $phpEx ?>"> 
              <?php echo $l_search?>
              </a></font></div>
          </td>
          <td BGCOLOR="<?php echo $color2?>">
            <div align="center"><font face="<?php echo $FontFace?>" size="<?php echo $FontSize1?>" color="<?php echo $textcolor?>"><a href="<?php echo $url_phpbb?>/<?php echo $faq_url ?>">
              <?php echo $l_faq?>
              </a> </font></div>
			  </td>
			  
		    <td BGCOLOR="<?php echo $color2?>"> 
            <div align="center"><font face="<?php echo $FontFace?>" size="<?php echo $FontSize1?>" color="<?php echo $textcolor?>"><a href="javascript:history.back(-2);">Go Back</a></font></div>
          </td>
        </tr>
        <tr> 
          <td BGCOLOR="<?php echo $color2?>"> 
            <div align="center"><font face="<?php echo $FontFace?>" size="<?php echo $FontSize1?>" color="<?php echo $textcolor?>"><a href="<?php echo $url_phpbb?>/viewpmsg.<?php echo $phpEx ?>"> 
              </a><a href="<?php echo $url_phpbb?>/<?php echo $faq_url ?>"> </a><a href="<?php echo $url_phpbb?>/viewpmsg.<?php echo $phpEx ?>"> 
              </a><a href="cstats.php">Stats</a></font></div>
          </td>
          <td BGCOLOR="<?php echo $color2?>"> 
            <div align="center"><font face="<?php echo $FontFace?>" size="<?php echo $FontSize1?>" color="<?php echo $textcolor?>"><a href="<?php echo $url_phpbb?>/bb_memberlist.<?php echo $phpEx ?>"> 
              </a><a href="<?php echo $url_phpbb?>/bb_memberlist.<?php echo $phpEx ?>">
              <?php echo $l_memberslist?>
              </a></font></div>
          </td>
          <td BGCOLOR="<?php echo $color2?>"> 
            <div align="center"><font face="<?php echo $FontFace?>" size="<?php echo $FontSize1?>" color="<?php echo $textcolor?>"><a href="<?php echo $url_phpbb?>/<?php echo $faq_url ?>"> 
              </a><a href="<?php echo $url_phpbb?>/viewpmsg.<?php echo $phpEx ?>"> 
              </a><a href="<?php echo $url_phpbb?>/bb_memberlist.<?php echo $phpEx ?>"> 
              </a><a href="<?php echo $url_phpbb?>/viewpmsg.<?php echo $phpEx ?>">
              <?php echo $l_privmsgs?>
              </a></font></div>
          ...
          <td BGCOLOR="<?php echo $color2?>"> 
            <div align="center"><font face="<?php echo $FontFace?>" size="<?php echo $FontSize1?>" color="<?php echo $textcolor?>"><a href="<?php echo $url_phpbb?>/viewpmsg.<?php echo $phpEx ?>"> 
              </a><a href="latestus.php">Latest posts</a></font></div>
          </td>
          <td BGCOLOR="<?php echo $color2?>">
		    ...
		    <td BGCOLOR="<?php echo $color2?>"> 
            <div align="center"><font face="<?php echo $FontFace?>" size="<?php echo $FontSize1?>" color="<?php echo $textcolor?>"><a href="#" onclick="javascript:document.location.href=document.location.href;">Refresh Page</a></font></div>
          </td>
        </tr>
      </table>
...
<TR>
	<TD COLSPAN="2" ALIGN="RIGHT"> 
      <div align="center"><FONT FACE="<?php echo $FontFace?>" SIZE="<?php echo $FontSize1?>" COLOR="<?php echo $textcolor?>"> 
        ...
        <table border="1" WIDTH="<?php echo $TableWidth?>"  BGCOLOR="<?php echo $color1?>" bordercolor="<?php echo $table_bgcolor?>">
          <tr> 
            <td WIDTH="100%"> 
              <div align="center"><font face="<?php echo $FontFace?>" size="<?php echo $FontSize1?>" color="<?php echo $textcolor?>"> 
                <?php 
