...
if ($posterdata[username]=="<font color=red>Xavic</font>"){
echo "\n<br><font size=-2>I'm a nice guy,<br>\nBut does that mean<br>\nthat you are<br>\nSafe?</font>";
} else {
   ...
   echo "\n<HR>";
   if ($posterdata[user_id] != -1 && $posterdata[username]!="<font color=red>Xavic</font>")
   {
   ...
   if(is_moderator($forum, $userdata["user_id"], $db) || $userdata[user_level] > 2 && $posterdata[username]!="<font color=red>Xavic</font>") {
      echo "&nbsp;&nbsp;<IMG SRC=\"images/div.gif\">\n";
