# THIS FILE DISPLAYS GUTS OF: Control Panel, New Template
...
&HeaderRow("$vars_config{BBName}: $vars_wordlets_cp{new_template_title}", "4", "#5d7790", "#FFFFFF", "center", "2");

&RegField ("Template Name", "TemplateName", "yes", "30", "30", "You must give each style template a name.  This name can be no more than 20 characters in length.", "");
...
&HeaderRow("You can easily change the font face and/or color, graphics, and background colors used throughout your bulletin board using this control panel page. Note: these changes affect only the bulletin board pages, not any of the control panel pages. For all colors, we recommend using hexadecimal codes \(e.g., #FFFFFF for \"white\", etc.\). The settings below are your overall style settings. You can customize these settings for individual forums in the Forum Settings area.", "4", "#FFFFFF", "#000000", "left", "1");
...
#&DoTextArea ("Language Meta Field", "language_meta", "", "You can insert your own language META code, which will be inserted in the HEAD tags of most displayed UBB pages.  Leave this field blank if you do not need to support a non English language.", "$vars_style{language_meta}", "3", "40");
...
$vars_style{thisCharset} = "ISO-8899-1" unless $vars_style{thisCharset};
&RegField ("Character Set", "thisCharset", "", "15", "15", "You may define a complete character set for this style template.  If you leave this character set blank, the board default character set as defined in General Display Settings will be used instead.  We recommend using ISO-8859-1.", "$vars_style{thisCharset}");

#&RegField ("Character Set", "thisCharset", "", "30", "60", "", "You may define a complete character set for this style template.  If you leave this character set blank, the board default character set as defined in General Display Settings will be used instead.  We recommend using ISO-8899-1.", "", "$vars_style{thisCharset}");
#&RegField ("Title        ", "BBTitle    ", "", "30", "60", "", "$vars_style{BBTitle}");
