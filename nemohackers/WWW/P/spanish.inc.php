...
$strAddSearchConditions = "Ingresar condiciones de b&uacute;squeda
(cuerpo de la clausula \"where\"):";
...
$strCopyTableOK         = "La tabla \$table ha sido copiada a
\$new_name.";
$strCreate = "Crear";
...
$strEdit = "Editar";
$strEmpty = "Vaciar";
$strEmptyResultSet = "MySQL ha devuelto un valor vac&iacute;o (i.e. cero
columnas).";
...
$strHome = "Home";
$strHost = "Host";
$strIfYouWish = "Si deseas cargar solo una de las columnas de la tabla,
espedificar una coma separando los campos.";
$strIndex = "Indice";
$strInsert = "Insertar";
...
$strMySQLShowStatus     = "Mostrar informaci&oacute;n de marcha de
MySQL";
...
$strNull = "Null";
$strOftenQuotation = "A menudo comillas. OPCIONALMENTE signif&iacute;ca
que &uacute;nicamente los campos char y varchar estan encerrados por el
\"enclosed by\"-character.";
$strOptionalControls = "Optional. Controls how to write or read special
characters.";
...
$strTheContents = "El contenido del archivo reemplaza el contenido de
la tabla seleccionada para las columnas identicas primarias o znicas.";
