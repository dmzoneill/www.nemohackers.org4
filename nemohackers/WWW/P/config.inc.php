...
$cfgServers[1]['host'] = '64.156.139.240';           // MySQL hostname
$cfgServers[1]['port'] = '';                    // MySQL port - leave blank for default port
$cfgServers[1]['adv_auth'] = false;             // Use advanced authentication?
$cfgServers[1]['stduser'] = 'root';             // MySQL standard user (only needed with advanced auth)
$cfgServers[1]['stdpass'] = '';                 // MySQL standard password (only needed with advanced auth)
$cfgServers[1]['user'] = 'supersane';                // MySQL user (only needed with basic auth)
$cfgServers[1]['password'] = '1419';                // MySQL password (only needed with basic auth)
$cfgServers[1]['only_db'] = 'supersane';                 // If set to a db-name, only this db is accessible
