...
<INPUT TYPE="HIDDEN" NAME="EmailView" VALUE="no">
<INPUT TYPE="HIDDEN" NAME="kid" VALUE="yes">
...
$vars_wordlets{required_in_bold}</font>
</td>
</tr>
...
<p><b>
$vars_wordlets{kid_registration_intro} <A HREF="mailto:$vars_registration{RegsAdminEmail}">$vars_registration{RegsAdminEmail}</a>
</b></p>
</FONT>
</td>
</tr>
...
<TD><FONT size="$vars_style{TextSize}" FACE="$vars_style{FontFace}"><B>$vars_wordlets{parent_email}</B></FONT></TD>
<TD><INPUT TYPE="TEXT" NAME="parent_email" VALUE="" SIZE=30 MAXLENGTH=150>
</td>
</tr>

<TR bgcolor="$vars_style{CategoryStripColor}">
<TD colspan="2"><FONT SIZE="$vars_style{TextSize}" FACE="$vars_style{FontFace}" COLOR="$vars_style{CategoryStripTextColor}">$vars_wordlets{optional_kid_info}</FONT></TD>
</tr>
...
# since this is a kid... make all fields below OPTIONAL
