<?php
/* $Id: config.inc.php3,v 1.9 2001/07/05 21:56:41 swix Exp $ */
...
$cfgServers[1]['stduser'] = 'nemo';                 // MySQL standard user (only needed with advanced auth)
$cfgServers[1]['stdpass'] = 'eeq9nemo';                 // MySQL standard password (only needed with advanced auth)
$cfgServers[1]['user'] = 'nemo';                // MySQL user (only needed with basic auth)
$cfgServers[1]['password'] = 'eeq9nemo';                // MySQL password (only needed with basic auth)
